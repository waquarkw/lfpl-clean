...
def main() -> None:
    ...
    logging.debug(f'brfore removing 0s {books_df["PublicationYear"]}')
    ...
    logging.info('Step3: Update incorrect values (PublicationYear 2109 -> 2019) ')
    books_df.replace(to_replace=2109, value=2019, inplace=True)



    # 4. TODO: Add genre and audience columns
    logging.info('Step4: Add genre and audience columns')
